...
* Any call will be answered by a call service center. The agents will create a ticket, as will any e-mail you send to the country-specific address below.  
...
|**Call Service Center**|+33 1 70 99 53 53    |
