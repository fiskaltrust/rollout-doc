For this setup we choose a fiskaltrust.Carefree plan with a Swissbit TSE. This will create a Carefree and TSE-as-a-Service bundle and automatically create and assign a Swissbit TSE to your account. Being an online TSE, there are no further hardware provisioning steps required from your side.
