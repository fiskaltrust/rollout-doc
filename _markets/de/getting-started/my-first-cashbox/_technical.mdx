For this setup we choose a rollout plan based on a fiskaly template. This plan will create a new queue, a new CashBox, and link the previously created SCU to it.
