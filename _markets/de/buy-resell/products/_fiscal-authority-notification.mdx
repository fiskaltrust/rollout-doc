...
This feature is currently not available, as the authorities have not published a final process yet. To our current knowledge, the post-registration of PosSystems already in use will be necessary, once it is published.
