...
#### Dealer overview
In the Menu _PosDealer_-> Notifications you'll get an overview of all connected _PosOperators_. Enabling _Automatic Notification_ will trigger the mail with the form being sent to the _PosOperator_.
