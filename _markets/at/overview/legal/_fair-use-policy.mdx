...
(english, see below for austrian version)

:::
(specifically for products #4154-0201, #4154, #204 through #206, and #215 through #218 as applicable).

Each POS-System is assigned to a CashBox in accordance with the following criteria:
* At least one CashBox must be operated per business.
* At least one CashBox must be operated per outlet.
* At least one CashBox must be operated per cash register manufacturer (PosSystem) per outlet.
* A maximum of 10 queues may be operated in a CashBox.
* A maximum of 10 input stations may be operated in one queue.
* A maximum of 10 signature creation units (SCU) may be operated in a CashBox.
* A maximum of 10 million documents per year may be processed in a CashBox.  

The following criteria must be observed for data transmissions via the ft.interface:
* A maximum of 100 automated reports via FinanzOnline are included per year.
* A maximum of 100 automated voucher checks via FinanzOnline are included per year.
* The audit-proof storage of the hash values of the RKSV-DEP are archived in accordance with § 132 BAO for 7 years after the deregistration.
* The storage of the E131-DEP is archived for 7 years after deregistration.

fiskaltrust reserves the right to adapt these regulations as required, in order to be able to provide long-term cooperation with cash register operators in accordance with the regulations.
...
(komplette österreichische Version)
...
## Download der Version für Österreich

[PDF Download der Fair Use Policy](media/fair-use-policy-austria.pdf)