...
3.  Checking or changing the settings for the invitations is **inevitable for both ways**. Therefore, regardless of the further way, prepare the settings first.  To do this, select `PosOperator` / `Invitation`.  
![invitation process preparation](images/11-onboarding-portal.png "11 invitation process individual")  
4. Control or change the settings for the invitation:  
...
|![Number 6](images/Numbers/circle-6o.png) |Change  again to the fiskaltrust.Portal and choose `PosOperator` / `Invitation`
 / PosOperators that should be invited.|
...
After choosing `PosOperator` / `Invitation`
 / History the Protocol for assignements of PosOperators offers you several features:
