...
|-----------|-----------------|-----------------------------------------------------|-------------------------|
| Kassenbetreiber-Account | Informationen zum Unternehmen / Stammdaten | St-IdNr | Die Steuernummer ist für die Meldung zwingend erforderlich. Die Verwendung der USt-IdNr ist nicht möglich. |
