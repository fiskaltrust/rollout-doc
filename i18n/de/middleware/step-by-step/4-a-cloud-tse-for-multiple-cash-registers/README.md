...
Diese Konfiguration beinhaltet eine Anzahl von traditionellen Queue/SCU Setups, in welchen sich alle fiskaltrust.SCUs jedoch eine allgemeine Cloud TSE teilen.

In diesem Tutorial werden wir folgendes aufsetzen

1. eine SCU, verbunden mit einer Cloud TSE
2. eine Queue
3. eine CashBox, welche die SCU und Queue der vorigen Schritte verbindet
